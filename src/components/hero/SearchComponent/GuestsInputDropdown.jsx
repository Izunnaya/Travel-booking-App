...
const GuestsInput = ({ guestHandler, selectGuest }) => {
  ...
  return (
    <div className="absolute top-[63px] w-full bg-stone-100 rounded-md left-0 p-4 cursor-default">
      <div className="flex justify-between items-center text-center mb-5  text-[17px] font-light">
        <div>
          <h4>Adults</h4>
        </div>
      ...
      <div className="flex justify-between items-center text-center my-3 pt-3  text-[17px] font-light">
        <div>
          <h4>Children</h4>
        </div>
